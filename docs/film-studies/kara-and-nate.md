...
| Two-hander with a lot of "I"; one person drives most beats | **Rule 5: one voice, the family's, collectively.** "We", never "I"; nobody is "the host" | **Dies.** R9's locked two-shot becomes a locked *three*-shot; R14's direct address is shared across Caleb, Alma and Sofia, not owned. |
