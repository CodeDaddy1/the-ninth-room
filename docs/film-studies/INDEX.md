...
- **Kara and Nate — "24 HOURS AT THE WORLD'S LARGEST GAS STATION (Buc-ee's)"** ([study](kara-and-nate.md), [source](https://www.youtube.com/watch?v=80oyG1Vl1Vc)) — The fastest film on the shelf (**21.6 cuts/min over 18:50**, ahead of Rober and Yes Theory) shot by two people with no crew, which settles that cut rate is not a budget line. Its one great structural finding is **monotonic deceleration**: cuts/min falls 39.6 → 31.0 → 24.9 → 23.6 → 16.5 → 14.0 across six chapters and median shot rises 1.27s → 2.70s, with no reversal in either column — the viewer is hustled into the premise and progressively allowed to sit down in it. Our edit plan has no pace target at all, so this is the biggest available change. Second finding, for every museum we will ever shoot: **the day arc is asserted, not photographed** — mean luminance never drops below 89 and only 17 seconds read as dark, so the 24 hours is carried by three ~2s clock cards (12:30 PM / 3:30 PM / 9 PM) that stop once real night arrives, plus one diegetic cut to a watch face. Beau Miles' real-object rule is confirmed a **third** time and now at a third budget: the progress ledger is handwritten on a paper fudge bag at 6:04, crossed off on camera at 13:20 and 17:49, held up complete at 18:05. And the study's sharpest gift is a warning about our own accuracy rule — the film shows its source page (66,335 sq ft) while the narration says 67,000 and a second source says 68,000, so **showing your source only helps if the source is date-stamped and agrees with you**. Peak protection returns for a sixth time, here as the film's *only* true silence: 4.49s at 14:28, laid exactly on the moment they admit the premise broke and their own title is no longer accurate.
