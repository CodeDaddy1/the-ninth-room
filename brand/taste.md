...
**UNSIGNED DRAFT — no doctrine may cite this until Caleb signs off statement by statement**

Mined 2026-08-24. Every statement below is derived only from decisions Caleb
actually recorded. Nothing here is inferred from the brand docs, and nothing
here is doctrine yet.
...
## Open questions for the sign-off pass
